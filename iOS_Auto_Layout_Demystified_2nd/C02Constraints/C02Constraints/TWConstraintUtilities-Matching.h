...
@interface TW_VIEW_CLASS (NamedConstraintSupport)

// Single
- (NSLayoutConstraint *) constraintNamed: (NSString *) aName;
- (NSLayoutConstraint *) constraintNamed: (NSString *) aName matchingView: (TW_VIEW_CLASS *) view;

// Multiple
- (NSArray *) constraintsNamed: (NSString *) aName;
- (NSArray *) constraintsNamed: (NSString *) aName matchingView: (TW_VIEW_CLASS *) view;
@end
...
- (BOOL) refersToView: (TW_VIEW_CLASS *) aView;
@property (nonatomic, readonly) BOOL isHorizontal;
@end

#pragma mark - Managing Matching Constraints
@interface TW_VIEW_CLASS (ConstraintMatching)
...
- (NSArray *) constraintsReferencingView: (TW_VIEW_CLASS *) view;
...
- (void) removeConstraintsNamed: (NSString *) name matchingView: (TW_VIEW_CLASS *) view;
@end