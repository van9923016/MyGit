...
@implementation TW_VIEW_CLASS (NamedConstraintSupport)
...
// Type not checked
- (NSLayoutConstraint *) constraintNamed: (NSString *) aName matchingView: (TW_VIEW_CLASS *) theView {
    if (!aName) return nil;
...
// Type not checked
- (NSArray *) constraintsNamed: (NSString *) aName matchingView: (TW_VIEW_CLASS *) theView {
    // For this, all constraints match a nil item
    if (!aName) return self.constraints;
...
- (BOOL) refersToView: (TW_VIEW_CLASS *) theView {
    if (!theView)
        return NO;
...
@implementation TW_VIEW_CLASS (ConstraintMatching)
...
- (NSLayoutConstraint *) constraintMatchingConstraint: (NSLayoutConstraint *) aConstraint {
    ...
    for (TW_VIEW_CLASS *view in views)
...
- (NSArray *) referencingConstraintsInSuperviews {
    NSMutableArray *array = [NSMutableArray array];
    for (TW_VIEW_CLASS *view in self.superviews) {
        for (NSLayoutConstraint *constraint in view.constraints) {
...
- (NSArray *) constraintsReferencingView: (TW_VIEW_CLASS *) theView {
    NSMutableArray *array = [NSMutableArray array];
    NSArray *views = [@[self] arrayByAddingObjectsFromArray:self.superviews];
...
- (void) removeConstraintsNamed: (NSString *) name matchingView: (TW_VIEW_CLASS *) theView {
